...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<ErrorDto> handleTicketSoldOutException(TicketSoldOutException ex) {
        ...
        ErrorDto errorDto = new ErrorDto();
        errorDto.setError("Sorry, Tickets are sold out for this ticket type");
    ...
    public ResponseEntity<ErrorDto> handleEventNotFoundException(EventNotFoundException ex) {
        ...
        ErrorDto errorDto = new ErrorDto();
        errorDto.setError("Event Not Found Exception");
        return new ResponseEntity<>(errorDto, HttpStatus.BAD_REQUEST);
    }
    ...
    public ResponseEntity<ErrorDto> handleEventNotFoundException(TicketTypeNotFoundException ex) {
        ...
        ErrorDto errorDto = new ErrorDto();
        errorDto.setError("Ticket Typ Not Found Exception");
        return new ResponseEntity<>(errorDto, HttpStatus.BAD_REQUEST);
    }
    ...
    public ResponseEntity<ErrorDto> handleConstraintViolation(
        ...
        String errorMessage = ex.getConstraintViolations()
                ...
                ).orElse("Constarint Violation Occurred");
